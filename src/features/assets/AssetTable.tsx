  ...
  return (
    <div>
      <div className="mb-4 flex flex-col gap-3 sm:flex-row sm:items-center">
        <select
          className="rounded border px-2 py-1 text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
          value={filters.type ?? ""}
          onChange={(e) =>
        ...
        <select
          ...
          onChange={(e) =>
            setFilters((f) => ({ ...f, market: e.target.value || undefined }))
          }
        >
              ...
              return (
                ...
                >
                  ...
                  <TableCell className="hidden lg:table-cell text-right">
                    {asset.costAmount?.toFixed(2) ?? "-"}
                  </TableCell>
                  <TableCell
                    className={`text-right ${profit >= 0 ? "text-success" : "text-danger"}`}
                  >
                    {profit.toFixed(2)}
                  </TableCell>
                  <TableCell className="text-right">
